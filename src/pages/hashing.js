...
import { MD5,SHA1, SHA384, SHA256, SHA512, HmacSHA256 } from 'crypto-js';
import './hashing.css';
...
export default function HashingForm(probs) {
    ...
    const [algorithms] = useState(['md5','sha1', 'sha256', 'HMAC-SHA256']);
    ...
    const handleTextInput =  (e) => {
        ...
        if (algorithm == 'sha1') {
            ...
            result = HmacSHA256(value,key).toString()
    ...
    const handleFileInput = (e) => {
        ...
        fr.onload =  () => {
            ...
            if (algorithm == 'sha1') {
                ...
                result = HmacSHA256(fr.result).toString();
            } else if (algorithm == 'md5') {
                result = MD5(fr.result).toString();
            }
    ...
    const handleAlgorithmChange =  (e) => {
        ...
        if (text_input) {
            ...
            if (value == 'sha1') {
                ...
                result = HmacSHA256(text_input).toString();
            }
        ...
        if (file_input) {
            ...
            if (value == 'sha1') {
                ...
                result = MD5(file_input).toString();
            }
        }
            ...
            <div className='hashing-content'>
                ...
                <div className="hashed-output">
                    ...
                    <div>
                        ...
                        <button className='Button_saved' onClick={(e)=>{
